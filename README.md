[README Кинопоиск.md](https://github.com/user-attachments/files/22583662/README.md)
...
#### Smoke тестирование
![Smoke тестирование - ТК Поиск фильма по названию](images/5.1.Smoke-тестирование-ТК-Поиск-фильма-по-названию.png)

![Smoke тестирование - ТК Просмотр основной информации](images/5.2.Smoke-тестирование-ТК-Просмотр-основной-информации.png)

![Smoke тестирование - ТК Просмотр и фильтрация по жанрам](images/5.3.Smoke-тестирование-ТК-Просмотр-и-фильтрация-по-жанрам.png)

![Smoke тестирование - ТК Проверка кросс-браузерности](images/5.4.Smoke-тестирование-ТК-Проверка-кросс-браузерности.png)

![Smoke тестирование - ТК Проверка адаптивности](images/5.5.Smoke-тестирование-ТК-Проверка-адаптивности.png)

#### Функциональное тестирование
![Чек-лист, функциональное тестирование - Поиск фильма](images/5.6.Чек-лист-функциональное-тестирование-Поиск-фильма.png)

![Чек-лист, функциональное тестирование - Рецензии](images/5.7.Чек-лист-функциональное-тестирование-Рецензии.png)

#### Нефункциональное тестирование
![Чек-лист, Нефункционал - UI, UX, производительность](images/5.8.Чек-лист-Нефункционал-UI-UX-производительность.png)

![Чек-лист, Нефункционал - Кросс-браузерность](images/5.9.Чек-лист-Нефункционал-Кросс-браузерность.png)

#### API тестирование
![API тестирование - ТК Кинопоиск](images/5.9.1.API-тестирование-ТК-Кинопоиск.png)
